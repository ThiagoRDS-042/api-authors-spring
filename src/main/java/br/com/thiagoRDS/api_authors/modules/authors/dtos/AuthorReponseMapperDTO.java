...
public record AuthorReponseMapperDTO(
    ...
    @Schema(requiredMode = RequiredMode.REQUIRED) AddressResponseMapperDTO address,
    @Schema(example = SwaggerAuthorExample.AVATAR_URL, requiredMode = RequiredMode.REQUIRED) String avatarUrl,
